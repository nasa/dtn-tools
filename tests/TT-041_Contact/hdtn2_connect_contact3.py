"""
***********************************************************************
** Sends bundles to and receives bundles from HDTN Node 2 for Contact 3
***********************************************************************
"""
...
print(f"Sending {num_bundles} bundles to HDTN Node 2 dest 104 ")
DTNGenUtils.send_bundles(num_bundles, 104, data_sender)
